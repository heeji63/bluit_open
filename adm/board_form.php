...
<section id="anc_bo_auth">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_write_level', 1, 10, (($w=='')? 2 : $board['bo_write_level'])) ?>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_reply_level', 1, 10, (($w=='')? 2 : $board['bo_reply_level'])) ?>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_comment_level', 1, 10, (($w=='')? 2 : $board['bo_comment_level'])) ?>
            </td>
            <td class="td_grpset">
